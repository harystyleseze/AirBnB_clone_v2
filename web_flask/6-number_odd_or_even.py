...
Routes:
    ...
    /number/<int:n>: Displays '<n> is a number' only 
        if <n> is an integer.
    /number_template/<int:n>: Displays an HTML page 
        showing '<n>' only if <n> is an integer.
    /number_odd_or_even/<int:n>: Displays an HTML page 
        showing whether <n> is odd or even only if <n> is an integer.
"""
...
def pythonText(text="is cool"):
    ...
    Returns:
        str: 'Python ' followed by the text with 
...
def number_odd_or_even(n):
    """
    Route to display an HTML page showing whether <n> is
         odd or even only if <n> is an integer.
    ...
    Returns:
        str: Rendered HTML page displaying whether the 
